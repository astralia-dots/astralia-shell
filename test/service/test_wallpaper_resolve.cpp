...
void test_wallpaper_resolve() {
    ...
    assert(wallpaper_service_column_path(cfg, "HDMI-1", 0, false) == "/global.png");
    ...
    assert(wallpaper_service_column_path(cfg, "HDMI-1", 3, false) == "/global.png");
    ...
    assert(wallpaper_service_column_override(cfg, "DP-1", 0, false) == "/dp1.png");
    ...
    assert(wallpaper_service_column_path(cfg, "HDMI-1", 0, true) == "/global.png");
