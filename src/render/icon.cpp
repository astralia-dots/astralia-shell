...
IconFont &icon_font() {
    static IconFont font = [] {
        ...
        const char *candidates[] = {
            ASTRALIA_SHELL_FONT_DIR "/tabler-icons.ttf",
...
RasterizedText rasterize_icon(const std::string &codepoint_utf8, int32_t scale, int px) {
    ...
    cairo_scaled_font_t *scaled_font = cairo_scaled_font_create(font.cairo_face, &font_matrix, &ctm, astralia_shell_icon_font_options());
