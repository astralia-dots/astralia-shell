...
inline constexpr const char *ADASTRIA_SHELL_FONT = "ComicShannsMono Nerd Font 13";

inline constexpr const char *ADASTRIA_SHELL_FONT_SMALL = "ComicShannsMono Nerd Font 9";

inline constexpr const char *ADASTRIA_SHELL_FONT_LARGE =
